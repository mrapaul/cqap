...
public class OMGParser implements MessageParser<OMG_O19>
{
    ...
    @Override public void convert(@NotNull OMG_O19 orm,
                                  @NotNull DetailedOrderBuilder orderBuilder) throws HL7Exception
    {
        ...
        for (String name : names)
        {
            ...
            switch (name)
            {
                ...
                case ("PATIENT"):
                {
                    OMG_O19_PATIENT patient = (OMG_O19_PATIENT) structure;
                    convert(patient);
                    break;
                }
                case ("ORDER"):
                {
                    OMG_O19_ORDER order = (OMG_O19_ORDER) structure;
                    convert(order);
                    break;
                }
            }
    ...
    private void convert(OMG_O19_PATIENT patient) throws HL7Exception
    {
        ...
        for (String name : names)
        {
            ...
            switch (name)
            {
                ...
                case ("PATIENT_VISIT"):
                {
                    OMG_O19_PATIENT_VISIT visit = (OMG_O19_PATIENT_VISIT) structure;
                    convert(visit);
                    break;
                }
                case ("GT1"):
...
//                    convert(patient.getGT1());
    ...
    private void convert(OMG_O19_PATIENT_VISIT visit) throws HL7Exception
    {
    ...
    private void convert(OMG_O19_ORDER order) throws HL7Exception
    {
